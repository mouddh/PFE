...
<body class="hold-transition sidebar-mini">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      {{-- <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <span class="dropdown-header">the notification is coming in here if we decided to </span>
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item">
            <i class="fas fa-envelope mr-2"></i> you have to 
 ...
 {{-- <button type="button" class="btn btn-primary btn-lg">ajouter un reclamation</button> --}}
