      ...
      <div class="col-lg-5 pl-lg-5 pb-3 py-lg-5">
        <form action="/update/{{ $Datas->id }}" method="POST" id="registration-form">
          ...
          <div class="form-group">
            ...
            <input name="password" id="password-register" class="form-control" type="password" placeholder="Create a password" value="{{Old('password', $Datas->password)}}"/>
          </div>

          <div class="form-group">
            <label for="password-register-confirm" class="text-muted mb-1"><small>Confirm Password</small></label>
            <input name="password" id="password-register-confirm" class="form-control" type="password" placeholder="Confirm password" value="{{Old('password', $Datas->password)}}" />
          </div>
