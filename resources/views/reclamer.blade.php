<x-layouts>
    <div class="container py-md-5 container--narrow">
        <form style="width:50%; margin:40px;"  action="/reclamer" method="POST">
          @csrf
          ...
          <div class="form-group">
            <label for="post-title" class="text-muted mb-1"><small>phone number</small></label>
            <input required name="title" id="post-title" class="form-control form-control-lg form-control-title" type="text" placeholder="" autocomplete="off" />
          </div>
          <label for="choice">Choose one:</label><br>
